...
DOWNLOAD_URL="https://github.com/area-of-dev/Chromium.AppImage/releases/download/latest/Chromium.AppImage"

date=$(date '+%y%m%d')
# Download the latest version
wget "$DOWNLOAD_URL" -O "Chromium$date.AppImage"
