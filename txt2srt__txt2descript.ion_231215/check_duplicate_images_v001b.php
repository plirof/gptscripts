...
foreach ($imageFiles as $i => $img1) {
    for ($j = $i + 1; $j < count($imageFiles); $j++) {
        ...
        if ($similarity > 75) { // You can adjust the similarity threshold as per your requirement
            ...
            $img1 = str_replace('',$folderPath, $img1);
            $img2 = str_replace('',$folderPath, $img2);
            echo '<img src="' .($img1) . '" alt="Image 1" width="200" height="200">';
            echo '<img src="' . ($img2).'" alt="Image 2" width="200" height="200">';
            echo 'Similarity: ' .  $similarity . '%';
            echo '<input type="checkbox" name="delete[]" value="' . $img1 . '"> Delete Image 1<br>';
            echo '<input type="checkbox" name="delete[]" value="' . $img2 . '"> Delete Image 2<br><br>';            
