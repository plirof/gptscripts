...
ToDO:
-Pass the language saved to edit_area for syntax hightlighting
...
<body>
    ...
    <?php } elseif (isset($_GET['edit']) && file_exists(PASTES_DIR . $_GET['edit'])) { ?>
        ...
        <form method="POST" name="theForm" id="theForm" onsubmit="editAreaLoader.getValue('content')" >
            ...
            <input type="password" name="passkey" value=1 required><br><br>
            ...
            <select name="language">
                ...
                <option value="basicsinclair" <?php if ($language == 'basicsinclair') echo 'selected'; ?>>HTML</option>
            </select><br><br>
